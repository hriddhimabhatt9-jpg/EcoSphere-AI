  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (result?.error) {
        ...
        showSuccess("Account created! Please sign in.", "Welcome");
        router.push("/login");
      }
    } catch (error) {
      console.error(error);
  ...
  return (
    <div className="w-full">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-display font-bold text-text-primary mb-2">Join EcoSphere AI</h2>
      ...
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-bg-primary px-2 text-text-muted">Or sign up with</span>
        </div>
      </div>
